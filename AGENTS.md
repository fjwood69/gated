...
This project is indexed by GitNexus as **gated** (3836 symbols, 8793 relationships, 207 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
