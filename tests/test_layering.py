...
class LayeringTests(unittest.TestCase):
    ...
    def test_tier_store_and_state_layers_are_engine_free(self) -> None:
        ...
        engine_free = ("policy_state.py", "policy_store.py", "snapshot.py", "snapshot_refresh.py",
                       "authority.py", "calibration_store.py", "candidate_store.py", "admission.py",
                       "closure_audit.py",
                       ...
                       "attestation.py", "attestation_store.py", "restore_controller.py",
                       "recal_queue.py", "recal_metrics.py", "c3_router.py", "observe_isolation.py")
        gate_dir = _ROOT / "gate"
        hits = [
            f"{name}: {line}"
