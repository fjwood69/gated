...
This project is indexed by GitNexus as **gated** (4995 symbols, 11578 relationships, 225 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
