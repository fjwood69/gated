...
This project is indexed by GitNexus as **gated** (5195 symbols, 11977 relationships, 229 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
